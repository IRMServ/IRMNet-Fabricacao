...
return array(
     'acl' => array(
        'Fabricacao' => array(
            'FABRICACAO' => array(
                'Fabricacao\Controller\Index:index',              
            ),
            'TI' => array(
                'Fabricacao\Controller\Index:index',              
            ),
        ...
        'routes' => array(
            ...
            'fabricacao' => array(
                ...
                'options' => array(
                    'route' => '/fabricacao',
                    'defaults' => array(
                       // '__NAMESPACE__' => 'Fabricacao\Controller',
                        'controller' => 'Fabricacao\Controller\Index',
                        'action' => 'index',
                    ),
                ),
            ),
    ...
    'controllers' => array(
        'invokables' => array(
            'Fabricacao\Controller\Index' => 'Fabricacao\Controller\IndexController'
        ),
    ),
    'view_manager' => array(
